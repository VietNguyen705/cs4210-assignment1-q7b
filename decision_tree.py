...
# SPECIFICATION: Reads contact_lens.csv, encodes categorical features, and builds a depth-2 decision tree using entropy
...
for row in db:
    Y.append(class_map[row[4].strip()])
